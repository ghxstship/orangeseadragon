...
CREATE INDEX idx_expense_receipts_ocr ON expense_receipts(ocr_processed);
...
CREATE INDEX idx_reimbursements_submitted ON reimbursements(submitted_at);
...
CREATE INDEX idx_reimbursement_items_expense ON reimbursement_items(expense_id);
...
CREATE INDEX idx_deduction_types_org ON deduction_types(organization_id);
...
CREATE INDEX idx_employee_deductions_active ON employee_deductions(employee_id, is_active) WHERE is_active = TRUE;
...
CREATE INDEX idx_bank_accounts_active ON bank_accounts(organization_id, is_active) WHERE is_active = TRUE;
...
CREATE INDEX idx_financial_transactions_bank ON financial_transactions(bank_account_id);
CREATE INDEX idx_financial_transactions_gl ON financial_transactions(gl_account_id);
CREATE INDEX idx_financial_transactions_date ON financial_transactions(transaction_date);
CREATE INDEX idx_financial_transactions_type ON financial_transactions(transaction_type);
CREATE INDEX idx_financial_transactions_source ON financial_transactions(source_type, source_id);
CREATE INDEX idx_financial_transactions_reconciled ON financial_transactions(bank_account_id, reconciled) 
