...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS emergency_contact_relationship VARCHAR(100);
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS emergency_contact_email VARCHAR(255);
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS allergies TEXT[];
        ...
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS blood_type VARCHAR(5);
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS w9_status VARCHAR(20) DEFAULT 'not_submitted'
        ...
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS w9_document_id UUID REFERENCES documents(id) ON DELETE SET NULL;
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS w8ben_status VARCHAR(20) DEFAULT 'not_applicable'
            CHECK (w8ben_status IN ('not_applicable', 'not_submitted', 'submitted', 'verified', 'expired'));
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS w8ben_submitted_at TIMESTAMPTZ;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS nda_status VARCHAR(20) DEFAULT 'none'
        ...
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS nda_expires_at TIMESTAMPTZ;
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS nda_document_id UUID REFERENCES documents(id) ON DELETE SET NULL;
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS non_compete_status VARCHAR(20) DEFAULT 'none'
            CHECK (non_compete_status IN ('none', 'active', 'expired', 'waived'));
        ALTER TABLE employee_profiles ADD COLUMN IF NOT EXISTS non_compete_expires_at TIMESTAMPTZ;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE organization_members ADD COLUMN IF NOT EXISTS role_tier org_role_tier DEFAULT 'member';
        ALTER TABLE organization_members ADD COLUMN IF NOT EXISTS department_scope TEXT[];
        ALTER TABLE organization_members ADD COLUMN IF NOT EXISTS project_scope UUID[];
        ALTER TABLE organization_members ADD COLUMN IF NOT EXISTS venue_scope UUID[];
    END IF;
END $$;
