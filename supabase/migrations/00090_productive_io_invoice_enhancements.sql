...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE invoices ADD COLUMN IF NOT EXISTS direction VARCHAR(20) DEFAULT 'receivable'
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE invoices ADD COLUMN IF NOT EXISTS subtotal DECIMAL(14,2) DEFAULT 0;
        ...
        ALTER TABLE invoices ADD COLUMN IF NOT EXISTS amount_paid DECIMAL(14,2) DEFAULT 0;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE invoices ADD COLUMN IF NOT EXISTS budget_id UUID REFERENCES budgets(id) ON DELETE SET NULL;
        ALTER TABLE invoices ADD COLUMN IF NOT EXISTS payment_milestone_id UUID REFERENCES payment_milestones(id) ON DELETE SET NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE invoice_line_items ADD COLUMN IF NOT EXISTS tax_amount DECIMAL(14,2) DEFAULT 0;
        ALTER TABLE invoice_line_items ADD COLUMN IF NOT EXISTS discount_percent DECIMAL(5,2) DEFAULT 0;
        ALTER TABLE invoice_line_items ADD COLUMN IF NOT EXISTS discount_amount DECIMAL(14,2) DEFAULT 0;
        ALTER TABLE invoice_line_items ADD COLUMN IF NOT EXISTS line_total DECIMAL(14,2) DEFAULT 0;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE invoice_line_items ADD COLUMN IF NOT EXISTS budget_category_id UUID REFERENCES budget_categories(id) ON DELETE SET NULL;
    END IF;
END $$;
