...
CREATE INDEX idx_email_messages_organization ON email_messages(organization_id);
CREATE INDEX idx_email_messages_account ON email_messages(email_account_id);
CREATE INDEX idx_email_messages_thread ON email_messages(provider_thread_id);
...
CREATE INDEX idx_email_messages_direction ON email_messages(direction, sent_at DESC);
...
CREATE INDEX idx_email_tracking_message ON email_tracking_events(email_message_id);
...
CREATE INDEX idx_email_threads_organization ON email_threads(organization_id);
...
CREATE INDEX idx_email_threads_deal ON email_threads(deal_id);
