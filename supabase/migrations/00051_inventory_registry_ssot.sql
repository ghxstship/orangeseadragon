...
CREATE INDEX IF NOT EXISTS idx_inventory_registry_organization ON inventory_registry(organization_id);
CREATE INDEX IF NOT EXISTS idx_inventory_registry_type ON inventory_registry(item_type);
CREATE INDEX IF NOT EXISTS idx_inventory_registry_entity ON inventory_registry(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_inventory_registry_sku ON inventory_registry(sku) WHERE sku IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_inventory_registry_serial ON inventory_registry(serial_number) WHERE serial_number IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_inventory_registry_status ON inventory_registry(status);
CREATE INDEX IF NOT EXISTS idx_inventory_registry_location ON inventory_registry(location_id) WHERE location_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_inventory_registry_holder ON inventory_registry(current_holder_id) WHERE current_holder_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_inventory_registry_category ON inventory_registry(category_id) WHERE category_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_inventory_registry_maintenance ON inventory_registry(next_maintenance_date) WHERE next_maintenance_date IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_inventory_registry_search ON inventory_registry USING GIN(
