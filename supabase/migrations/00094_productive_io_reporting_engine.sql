...
-- Extend existing report_definitions table (originally from 00013_compliance_reports.sql)
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS base_entity VARCHAR(50);
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS joins JSONB DEFAULT '[]';
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS aggregations JSONB DEFAULT '[]';
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS chart_type VARCHAR(30);
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS chart_config JSONB DEFAULT '{}';
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS default_date_range VARCHAR(30) DEFAULT 'this_month';
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS date_field VARCHAR(100);
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS visibility VARCHAR(20) DEFAULT 'private';
ALTER TABLE report_definitions ADD COLUMN IF NOT EXISTS is_favorite BOOLEAN DEFAULT FALSE;
...
-- Extend existing dashboard_widgets table (originally from 00013_compliance_reports.sql)
...
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS grid_x INTEGER DEFAULT 0;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS grid_y INTEGER DEFAULT 0;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS grid_w INTEGER DEFAULT 4;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS grid_h INTEGER DEFAULT 3;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS report_definition_id UUID;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS query_override JSONB;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS color_scheme VARCHAR(30);
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS show_trend BOOLEAN DEFAULT FALSE;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS trend_period VARCHAR(20);
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS last_refreshed_at TIMESTAMPTZ;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS cached_data JSONB;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS position INTEGER DEFAULT 0;
ALTER TABLE dashboard_widgets ADD COLUMN IF NOT EXISTS is_visible BOOLEAN DEFAULT TRUE;
