...
DROP TRIGGER IF EXISTS update_backlogs_updated_at ON backlogs;
...
DROP TRIGGER IF EXISTS update_radio_channels_updated_at ON radio_channels;
...
DROP TRIGGER IF EXISTS update_tech_specs_updated_at ON tech_specs;
...
DROP TRIGGER IF EXISTS update_advancing_updated_at ON advancing;
...
DROP TRIGGER IF EXISTS update_showcase_updated_at ON showcase;
