...
CREATE INDEX IF NOT EXISTS idx_people_directory_organization ON people_directory(organization_id);
CREATE INDEX IF NOT EXISTS idx_people_directory_type ON people_directory(person_type);
CREATE INDEX IF NOT EXISTS idx_people_directory_entity ON people_directory(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_people_directory_email ON people_directory(email) WHERE email IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_people_directory_name ON people_directory(full_name);
CREATE INDEX IF NOT EXISTS idx_people_directory_company ON people_directory(company_id) WHERE company_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_people_directory_internal ON people_directory(is_internal);
CREATE INDEX IF NOT EXISTS idx_people_directory_tags ON people_directory USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_people_directory_search ON people_directory USING GIN(
