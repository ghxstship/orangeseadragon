...
CREATE INDEX idx_status_tracker_organization ON status_tracker(organization_id);
CREATE INDEX idx_status_tracker_entity ON status_tracker(entity_type, entity_id);
CREATE INDEX idx_status_tracker_status ON status_tracker(current_status);
CREATE INDEX idx_status_tracker_category ON status_tracker(status_category);
CREATE INDEX idx_status_tracker_project ON status_tracker(project_id) WHERE project_id IS NOT NULL;
CREATE INDEX idx_status_tracker_event ON status_tracker(event_id) WHERE event_id IS NOT NULL;
CREATE INDEX idx_status_tracker_due_date ON status_tracker(due_date) WHERE due_date IS NOT NULL;
CREATE INDEX idx_status_tracker_changed_at ON status_tracker(changed_at DESC);
