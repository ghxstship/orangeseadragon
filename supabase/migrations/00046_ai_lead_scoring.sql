...
CREATE INDEX idx_scoring_models_organization ON scoring_models(organization_id);
CREATE INDEX idx_scoring_models_active ON scoring_models(is_active, is_default);
...
CREATE INDEX idx_lead_scores_label ON lead_scores(score_label);
CREATE INDEX idx_lead_scores_hot ON lead_scores(organization_id, score_label) 
...
CREATE INDEX idx_scoring_events_contact ON scoring_events(contact_id);
CREATE INDEX idx_scoring_events_type ON scoring_events(event_type);
CREATE INDEX idx_scoring_events_occurred ON scoring_events(occurred_at DESC);
