...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS budget_type budget_pricing_type DEFAULT 'fixed_price';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS parent_budget_id UUID REFERENCES budgets(id) ON DELETE SET NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS alert_threshold_warning DECIMAL(5,2) DEFAULT 75.00;
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS alert_threshold_critical DECIMAL(5,2) DEFAULT 90.00;
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS alert_threshold_exceeded DECIMAL(5,2) DEFAULT 100.00;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS markup_type VARCHAR(20) DEFAULT 'percentage' 
            CHECK (markup_type IN ('percentage', 'flat_fee', 'cost_plus', 'none'));
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS markup_value DECIMAL(14,2) DEFAULT 0;
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS agency_fee_amount DECIMAL(14,2) DEFAULT 0;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS retainer_amount DECIMAL(14,2);
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS retainer_hours DECIMAL(8,2);
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS retainer_period VARCHAR(20) 
            CHECK (retainer_period IN ('weekly', 'monthly', 'quarterly', 'annually'));
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS retainer_rollover BOOLEAN DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS revenue_amount DECIMAL(14,2) DEFAULT 0;
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS cost_amount DECIMAL(14,2) DEFAULT 0;
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS profit_amount DECIMAL(14,2) GENERATED ALWAYS AS (revenue_amount - cost_amount) STORED;
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS profit_margin DECIMAL(5,2);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS invoiced_amount DECIMAL(14,2) DEFAULT 0;
        ALTER TABLE budgets ADD COLUMN IF NOT EXISTS draft_invoice_amount DECIMAL(14,2) DEFAULT 0;
    END IF;
END $$;
