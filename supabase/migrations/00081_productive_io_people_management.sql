...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE employee_profiles ADD COLUMN emergency_contact_relation VARCHAR(100);
        ALTER TABLE employee_profiles ADD COLUMN medical_notes TEXT;
        ALTER TABLE employee_profiles ADD COLUMN preferred_pronouns VARCHAR(50);
        ALTER TABLE employee_profiles ADD COLUMN preferred_name VARCHAR(255);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE employee_profiles ADD COLUMN blackout_dates JSONB DEFAULT '[]';
        ALTER TABLE employee_profiles ADD COLUMN preferred_regions TEXT[];
        ALTER TABLE employee_profiles ADD COLUMN max_travel_days_per_month INTEGER;
        ALTER TABLE employee_profiles ADD COLUMN w9_on_file BOOLEAN DEFAULT FALSE;
        ALTER TABLE employee_profiles ADD COLUMN w9_submitted_at TIMESTAMPTZ;
        ALTER TABLE employee_profiles ADD COLUMN nda_signed BOOLEAN DEFAULT FALSE;
