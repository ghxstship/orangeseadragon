...
DROP POLICY IF EXISTS "Users can view payment attempts for their tenant" ON payment_attempts;
...
DROP POLICY IF EXISTS "Users can create payment attempts for their tenant" ON payment_attempts;
...
DROP POLICY IF EXISTS "Users can view stripe events for their tenant" ON stripe_events;
...
RETURNS VOID AS $$
BEGIN
  INSERT INTO stripe_events (organization_id, stripe_event_id, event_type, payload)
  VALUES (p_organization_id, p_event_id, p_event_type, p_payload)
