...
CREATE INDEX idx_assignments_start_time ON assignments(start_time) WHERE start_time IS NOT NULL;
CREATE INDEX idx_assignments_project ON assignments(project_id) WHERE project_id IS NOT NULL;
CREATE INDEX idx_assignments_event ON assignments(event_id) WHERE event_id IS NOT NULL;
