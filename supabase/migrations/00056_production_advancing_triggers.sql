...
DROP TRIGGER IF EXISTS trg_advance_item_calendar_sync ON advance_items;
...
DROP TRIGGER IF EXISTS trg_advance_item_calendar_delete ON advance_items;
...
DROP TRIGGER IF EXISTS trg_advance_item_activity_feed ON advance_items;
...
DROP TRIGGER IF EXISTS trg_fulfillment_activity_feed ON advance_item_fulfillment;
...
DROP TRIGGER IF EXISTS trg_production_advance_activity_feed ON production_advances;
...
DROP TRIGGER IF EXISTS trg_vendor_rating_aggregation ON vendor_ratings;
...
DROP TRIGGER IF EXISTS trg_fulfillment_auto_status ON advance_item_fulfillment;
