...
CREATE INDEX IF NOT EXISTS idx_location_registry_organization ON location_registry(organization_id);
CREATE INDEX IF NOT EXISTS idx_location_registry_type ON location_registry(location_type);
CREATE INDEX IF NOT EXISTS idx_location_registry_category ON location_registry(location_category);
CREATE INDEX IF NOT EXISTS idx_location_registry_entity ON location_registry(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_location_registry_parent ON location_registry(parent_id) WHERE parent_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_location_registry_city ON location_registry(city) WHERE city IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_location_registry_geo ON location_registry(latitude, longitude) WHERE latitude IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_location_registry_active ON location_registry(is_active);
CREATE INDEX IF NOT EXISTS idx_location_registry_search ON location_registry USING GIN(
