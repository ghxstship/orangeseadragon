...
-- Indexes
CREATE INDEX idx_build_strike_org ON build_strike_schedules(organization_id);
CREATE INDEX idx_build_strike_production ON build_strike_schedules(production_id);
CREATE INDEX idx_build_strike_event ON build_strike_schedules(event_id);
CREATE INDEX idx_build_strike_venue ON build_strike_schedules(venue_id);
CREATE INDEX idx_build_strike_type ON build_strike_schedules(schedule_type);
CREATE INDEX idx_build_strike_status ON build_strike_schedules(status);
CREATE INDEX idx_build_strike_dates ON build_strike_schedules(scheduled_start, scheduled_end);
CREATE INDEX idx_build_strike_crew_call ON build_strike_schedules(crew_call_id);
CREATE INDEX idx_build_strike_depends ON build_strike_schedules(depends_on_id);
