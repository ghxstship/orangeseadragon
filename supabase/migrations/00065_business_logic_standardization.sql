...
DROP TRIGGER IF EXISTS trg_notify_approval_request ON approval_requests;
...
DROP TRIGGER IF EXISTS trg_notify_approval_decision ON approval_requests;
...
DROP POLICY IF EXISTS "approval_history_org_access" ON approval_history;
...
DROP POLICY IF EXISTS "number_sequences_org_access" ON number_sequences;
