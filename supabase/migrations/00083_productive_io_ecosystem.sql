...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE folders ADD COLUMN visibility VARCHAR(20) DEFAULT 'team'
            CHECK (visibility IN ('private', 'team', 'organization', 'client'));
        ALTER TABLE folders ADD COLUMN client_visible BOOLEAN DEFAULT FALSE;
        ALTER TABLE folders ADD COLUMN password_protected BOOLEAN DEFAULT FALSE;
