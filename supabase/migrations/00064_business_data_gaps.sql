...
CREATE INDEX IF NOT EXISTS idx_products_active ON products(organization_id, is_active) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_price_lists_type ON price_lists(price_list_type);
CREATE INDEX IF NOT EXISTS idx_price_lists_effective ON price_lists(effective_date, expiration_date);
CREATE INDEX IF NOT EXISTS idx_price_lists_company ON price_lists(company_id);
CREATE INDEX IF NOT EXISTS idx_price_lists_active ON price_lists(organization_id, is_active) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_price_list_items_variant ON price_list_items(product_variant_id);
...
CREATE INDEX IF NOT EXISTS idx_sponsors_company ON sponsors(company_id);
CREATE INDEX IF NOT EXISTS idx_sponsors_tier ON sponsors(tier);
CREATE INDEX IF NOT EXISTS idx_sponsors_active ON sponsors(organization_id, is_active) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_sponsorships_org ON sponsorships(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_sponsorships_production ON sponsorships(production_id);
...
CREATE INDEX IF NOT EXISTS idx_sponsorship_deliverables_sponsorship ON sponsorship_deliverables(sponsorship_id);
CREATE INDEX IF NOT EXISTS idx_sponsorship_deliverables_status ON sponsorship_deliverables(status);
CREATE INDEX IF NOT EXISTS idx_sponsorship_deliverables_due ON sponsorship_deliverables(due_date) 
...
CREATE INDEX IF NOT EXISTS idx_product_bundles_org ON product_bundles(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_product_bundle_items_service ON product_bundle_items(service_id);
...
DROP POLICY IF EXISTS "product_variants_org_access" ON product_variants;
...
-- Price Lists
DROP POLICY IF EXISTS "price_lists_org_access" ON price_lists;
CREATE POLICY "price_lists_org_access" ON price_lists 
    FOR ALL USING (is_organization_member(organization_id));

DROP POLICY IF EXISTS "price_list_items_org_access" ON price_list_items;
...
-- Sponsors
DROP POLICY IF EXISTS "sponsors_org_access" ON sponsors;
CREATE POLICY "sponsors_org_access" ON sponsors 
    FOR ALL USING (is_organization_member(organization_id));

DROP POLICY IF EXISTS "sponsorships_org_access" ON sponsorships;
CREATE POLICY "sponsorships_org_access" ON sponsorships 
    FOR ALL USING (is_organization_member(organization_id));

DROP POLICY IF EXISTS "sponsorship_deliverables_org_access" ON sponsorship_deliverables;
...
-- Bundles
DROP POLICY IF EXISTS "product_bundles_org_access" ON product_bundles;
CREATE POLICY "product_bundles_org_access" ON product_bundles 
    FOR ALL USING (is_organization_member(organization_id));

DROP POLICY IF EXISTS "product_bundle_items_org_access" ON product_bundle_items;
...
DROP TRIGGER IF EXISTS trg_sponsorship_deliverables_updated_at ON sponsorship_deliverables;
