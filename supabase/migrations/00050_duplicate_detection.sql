...
CREATE INDEX IF NOT EXISTS idx_duplicate_candidates_organization ON duplicate_candidates(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_duplicate_candidates_pending ON duplicate_candidates(organization_id, status) 
...
CREATE INDEX IF NOT EXISTS idx_merge_audit_organization ON merge_audit_log(organization_id);
CREATE INDEX IF NOT EXISTS idx_merge_audit_entity ON merge_audit_log(entity_type, surviving_id);
