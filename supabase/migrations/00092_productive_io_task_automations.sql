...
-- Extend existing custom_field_definitions table (originally from 00009_workflows_documents.sql)
ALTER TABLE custom_field_definitions ADD COLUMN IF NOT EXISTS is_sortable BOOLEAN DEFAULT TRUE;
ALTER TABLE custom_field_definitions ADD COLUMN IF NOT EXISTS show_in_table BOOLEAN DEFAULT FALSE;
ALTER TABLE custom_field_definitions ADD COLUMN IF NOT EXISTS show_in_form BOOLEAN DEFAULT TRUE;
ALTER TABLE custom_field_definitions ADD COLUMN IF NOT EXISTS formula_expression TEXT;
ALTER TABLE custom_field_definitions ADD COLUMN IF NOT EXISTS created_by UUID;
...
-- Extend existing custom_field_values table (originally from 00009_workflows_documents.sql)
ALTER TABLE custom_field_values ADD COLUMN IF NOT EXISTS value_text TEXT;
ALTER TABLE custom_field_values ADD COLUMN IF NOT EXISTS value_number DECIMAL(14,4);
ALTER TABLE custom_field_values ADD COLUMN IF NOT EXISTS value_date TIMESTAMPTZ;
