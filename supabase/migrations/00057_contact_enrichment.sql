...
CREATE INDEX IF NOT EXISTS idx_enrichment_providers_organization ON enrichment_providers(organization_id);
CREATE INDEX IF NOT EXISTS idx_enrichment_providers_active ON enrichment_providers(is_active) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_enrichment_results_status ON enrichment_results(status);
...
CREATE INDEX IF NOT EXISTS idx_enrichment_queue_pending ON enrichment_queue(status, scheduled_at) 
