...
CREATE INDEX IF NOT EXISTS idx_meeting_types_organization ON meeting_types(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_meeting_bookings_organization ON meeting_bookings(organization_id);
CREATE INDEX IF NOT EXISTS idx_meeting_bookings_type ON meeting_bookings(meeting_type_id);
CREATE INDEX IF NOT EXISTS idx_meeting_bookings_host ON meeting_bookings(host_id);
CREATE INDEX IF NOT EXISTS idx_meeting_bookings_contact ON meeting_bookings(contact_id);
CREATE INDEX IF NOT EXISTS idx_meeting_bookings_deal ON meeting_bookings(deal_id);
CREATE INDEX IF NOT EXISTS idx_meeting_bookings_starts ON meeting_bookings(starts_at);
CREATE INDEX IF NOT EXISTS idx_meeting_bookings_status ON meeting_bookings(status);
CREATE INDEX IF NOT EXISTS idx_meeting_bookings_upcoming ON meeting_bookings(host_id, starts_at) 
...
CREATE INDEX IF NOT EXISTS idx_availability_overrides_dates ON availability_overrides(starts_at, ends_at);
