...
CREATE INDEX IF NOT EXISTS idx_show_call_logs_item ON show_call_logs(runsheet_item_id);

ALTER TABLE show_call_logs ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "show_call_logs_org_access" ON show_call_logs;
...
CREATE INDEX IF NOT EXISTS idx_notification_rules_entity ON notification_rules(entity_type, trigger_type);

ALTER TABLE notification_rules ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "notification_rules_org_access" ON notification_rules;
