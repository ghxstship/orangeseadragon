...
CREATE TABLE IF NOT EXISTS workflow_runs (
    ...
    -- Example: [{ "action_id": "...", "status": "success", "result": {...} }]
...
CREATE INDEX idx_workflow_runs_entity ON workflow_runs(trigger_entity_type, trigger_entity_id);
...
INSERT INTO workflow_templates (name, description, category, trigger_type, trigger_config, actions, icon, is_featured) VALUES
(
    'Welcome New Contact',
