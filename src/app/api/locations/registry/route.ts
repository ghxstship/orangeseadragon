...
export async function GET(request: NextRequest) {
  ...
  const items = (data || []).map((location) => ({
    ...
    address: location.legacy_address,
    city: location.legacy_city,
    state: location.legacy_state,
    country: location.legacy_country,
    postalCode: location.legacy_postal_code,
