...
const productionDashboardSections: DashboardSection[] = [
  {
    id: 'metrics',
    widgets: [
  ...
  },
  {
    ...
    widgets: [
      ...
      { id: 'reports-nav', title: 'Reports', description: 'Production analytics and performance metrics', type: 'custom', size: 'medium' },
    ],
  },
  {
    id: 'events',
...
export default function ProductionPage() {
  return (
    <DashboardTemplate
      ...
      subtitle="Plan and execute events, shows, and productions"
      sections={productionDashboardSections}
    />
  );
}
