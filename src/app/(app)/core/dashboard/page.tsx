...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      {/* KPI Cards Row — 6 KPIs per directive */}
      <div className="col-span-full">
        <div className="grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
          ...
          <StatCard
            ...
            value={isDataLoading ? "..." : `${kpiStats.teamUtilization}%`}
            icon={Users}
            trend={
              kpiStats.teamUtilization >= 70
                ? { value: kpiStats.teamUtilization, isPositive: true }
                : { value: kpiStats.teamUtilization, isPositive: false }
            }
            description="capacity used"
          />
          <StatCard
            title="Revenue MTD"
            value={isDataLoading ? "..." : new Intl.NumberFormat(DEFAULT_LOCALE, { style: "currency", currency: "USD", maximumFractionDigits: 0 }).format(kpiStats.revenueMTD)}
            icon={TrendingUp}
      ...
      {/* Charts Row — Project Status Distribution + Budget Burn Rates */}
      <div className="col-span-full">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <span className={cn(
                            ...
                            isOverBudget ? "text-destructive" : isAtRisk ? "text-amber-500" : "text-emerald-500"
                          )}>
                            {burnPct}%
                          </span>
                        </div>
                        <Progress
                          ...
                          className={cn(
                            ...
                            isAtRisk && !isOverBudget && "[&>div]:bg-amber-500"
                          )}
                        />
