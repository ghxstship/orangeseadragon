...
const tabsTriggerStyles: Record<TabsVariant, string> = {
  ...
  spatial:
    "rounded-xl px-6 py-2 transition-all duration-500 data-[state=active]:bg-primary/20 data-[state=active]:text-primary data-[state=active]:shadow-tab-active data-[state=active]:border-primary/20 border border-transparent",
};
