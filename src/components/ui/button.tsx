...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-[13px] font-bold tracking-wide ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-primary-button hover:shadow-primary-button-hover hover:-translate-y-[1px] active:translate-y-[0px]",
        destructive:
        ...
        glass: "glass text-foreground hover:bg-white/10 dark:hover:bg-white/5 border border-white/20 hover:border-white/30 shadow-glass-button backdrop-blur-md",
        spatial: "bg-gradient-to-b from-white/80 to-white/40 dark:from-white/10 dark:to-white/5 border border-white/20 shadow-spatial-button hover:shadow-spatial-button-hover hover:-translate-y-[1px] text-foreground backdrop-blur-md",
