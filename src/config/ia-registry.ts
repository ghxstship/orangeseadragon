...
export const productionsModule: RouteGroup = {
  ...
  pages: [
    ...
    { path: "/punch-lists", title: "Punch Lists", layout: "entity-list", entity: "punchItem", icon: "ListChecks", description: "Deficiency & fix items", status: "not-started" },
    {
      ...
      tabs: [
        { key: "riders", label: "Riders", type: "related", entity: "rider", foreignKey: "advancingId", icon: "FileText" },
        { key: "tech-specs", label: "Tech Specs", type: "related", entity: "techSpec", foreignKey: "advancingId", icon: "FileCode" },
      ],
      status: "not-started",
    },
  ],
